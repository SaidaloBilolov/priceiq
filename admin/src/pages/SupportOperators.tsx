...
import { Headphones, Plus, Phone, CheckCircle2, AlertCircle, Trash2, Edit2, X, Search, ShieldCheck, UserCheck, Power } from 'lucide-react';
import { SupportOperator } from '../types';
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 bg-gray-900 border border-gray-800 p-6 rounded-2xl shadow-xl">
        <div>
          ...
          <p className="text-gray-400 text-xs mt-1">
            Yangi support operator qo'shing va Telegram Support Bot orqali mijozlar murojaatlarini qabul qiluvchi xodimlarni biriktiring
          </p>
        </div>
      ...
      <div className="relative">
        <input
          ...
          placeholder="Operator ismi yoki telefon raqami bo'yicha qidirish..."
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              ...
              <div>
                ...
                <p className="text-gray-500 text-[11px] mt-1">
                  Ushbu raqam egasi Support Botga kirib raqamini yuborganda, bot uni Support Operator sifatida ro'yxatdan o'tkazadi va foydalanuvchilar murojaatlarini yo'naltiradi.
                </p>
              </div>
